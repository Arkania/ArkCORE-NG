...
-- 1.
SET @NPC := 222080; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 2.
SET @NPC := 221244; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 3.
SET @NPC := 221252;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
DELETE FROM `creature_addon` WHERE `guid`=222158; -- guid by arkcore
INSERT INTO `creature_addon` (`guid`,`path_id`,`mount`,`bytes1`,`bytes2`,`emote`,`auras`) VALUES 
(222158,0,0,0,1,27, '');

-- 4.
SET @NPC := 221536;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 5.
SET @NPC := 221247;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- remove rndmmovement
UPDATE `creature` SET `spawndist`=0, `MovementType`=0 WHERE  `guid`=222543; -- guid by arkcore
 
-- 6.
SET @NPC := 221249; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 7.
SET @NPC := 200797; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 8.
SET @NPC := 227452; -- guid by arkcore
SET @PATH := @NPC * 10;
...
DELETE FROM `creature_formations` WHERE `leaderGUID`=227452; -- guid by arkcore
INSERT INTO `creature_formations` (`leaderGUID`, `memberGUID`, `dist`, `angle`, `groupAI`, `point_1`, `point_2`) VALUES 
(227452, 227452, 0, 0, 2, 0, 0),
(227452, 227451, 4, 0, 2, 0, 0);
