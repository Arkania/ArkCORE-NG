...
UPDATE creature_template_addon SET `auras`='' WHERE `entry`=32638; -- Traveler's Tundra Mammoth
UPDATE creature_template_addon SET `auras`='' WHERE `entry`=32639; -- Traveler's Tundra Mammoth
...
UPDATE creature_template_addon SET `mount`=8797, `auras`='29266' WHERE `entry`=43250; -- Permanent Feign Death
