...
-- Pathing for Venom Stalker Entry: 15976 'ark FORMAT' 
SET @NPC := 190237;
SET @PATH := @NPC * 10;
...
DELETE FROM `creature_formations` WHERE `leaderGUID` IN (190241,190240,190239,190238,190237,190236,190231,190230);
DELETE FROM `creature_formations` WHERE `memberGUID` IN (190241,190240,190239,190238,190237,190236,190231,190230);
INSERT INTO `creature_formations` (`leaderGUID`,`memberGUID`,`dist`,`angle`,`groupAI`,`point_1`,`point_2`) VALUES
(190237,190237,0,0,2,0,0),
(190237,190236,8,360,2,0,0),
(190241,190241,0,0,2,0,0),
(190241,190240,8,360,2,0,0),
(190231,190231,0,0,2,0,0),
(190231,190230,8,360,2,0,0),
(190239,190239,0,0,2,0,0),
(190239,190238,8,360,2,0,0);

-- Pathing for Poisonous Skitterer Entry: 15977 'ark FORMAT' 
SET @NPC := 190196;
SET @PATH := @NPC * 10;
