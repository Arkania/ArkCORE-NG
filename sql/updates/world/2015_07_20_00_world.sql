...
-- 1. Onslaught Infantry entry 27330
SET @NPC := 226872;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 3. Onslaught Raven Archon -- 27357
SET @NPC := 217958;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 4. Onslaught Raven Archon -- 27357 
SET @NPC := 217962;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 5. Onslaught Raven Archon -- 27357 
SET @NPC := 217957;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 6. Onslaught Death Knight  -- entry 27367
SET @NPC := 217238; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 7. Onslaught Death Knight -- entry 27367  
SET @NPC := 217237; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 8. Onslaught Raven Archon -- 27357 
SET @NPC := 217960;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 9. Onslaught Death Knight entry 27367 
SET @NPC := 217256; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 10. Onslaught Death Knight entry 27367
SET @NPC := 217277; -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 11. Onslaught Death Knight entry 27367
SET @NPC := 217278;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 12. Onslaught Death Knight entry 27367
SET @NPC := 217260;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 13. Onslaught Death Knight entry 27367
SET @NPC := 217276;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 14. Onslaught Death Knight entry 27367
SET @NPC := 217258;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 15. Onslaught Raven Archon -- 27357
SET @NPC := 217961;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 16. Onslaught Death Knight entry 27367
SET @NPC := 217281;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 17. Onslaught Death Knight entry 27367
SET @NPC := 217274;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 18. Onslaught Death Knight entry 27367
SET @NPC := 217262;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 19. Onslaught Death Knight entry 27367
SET @NPC := 217275;  -- guid by arkcore
SET @PATH := @NPC * 10;
...
-- 20. Onslaught Death Knight entry 27367
SET @NPC := 217253;  -- guid by arkcore
SET @PATH := @NPC * 10;
