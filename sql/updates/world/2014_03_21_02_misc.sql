...
update creature_template set AIName="", ScriptName="npc_prince_liam_greymane_phase_2" where entry=34913;
update creature_template set AIName="", ScriptName="npc_gilneas_city_guard_phase_2" where entry=34916;
update creature_template set AIName="", ScriptName="npc_rampaging_worgen_phase_2" where entry=35660;
