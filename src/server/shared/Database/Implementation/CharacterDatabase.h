...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CHARACTER_QUESTGIVER_QUEST,
    CHAR_DEL_CHARACTER_QUESTGIVER_QUEST,
    CHAR_INS_CHARACTER_QUESTGIVER_QUEST,
    ...
    // Archaeology old
    CHAR_SEL_PLAYER_FIND_IDS,
    CHAR_SEL_PLAYER_SITE_IDS,
    CHAR_SEL_PLAYER_SITES,
    CHAR_REP_PLAYER_SITES,
    CHAR_DEL_PLAYER_SITES,

    CHAR_INS_PLAYER_COMPLETED_PROJECT,
    CHAR_SEL_PLAYER_COMPLETED_PROJECT_COUNT,
    CHAR_SEL_PLAYER_COMPLETED_PROJECT_TIME,
    CHAR_UPD_PLAYER_COMPLETED_PROJECT_COUNT,

    // Archaeology
    CHAR_SEL_PLAYER_DIGGING_ALL,
    CHAR_DEL_PLAYER_DIGGING,
    CHAR_DEL_PLAYER_DIGGING_ALL,
    CHAR_REP_PLAYER_DIGGING,
    CHAR_INS_PLAYER_DIGGING,

    CHAR_SEL_PLAYER_CURRENT_PROJECT,
    CHAR_DEL_PLAYER_CURRENT_PROJECT,
    CHAR_DEL_PLAYER_CURRENT_PROJECT2,
    CHAR_INS_PLAYER_CURRENT_PROJECT,

    CHAR_SEL_PLAYER_COMPLETED_PROJECT,
    CHAR_REP_PLAYER_COMPLETED_PROJECT,

    CHAR_DEL_PLAYER_SURVEY_DATA,
    CHAR_DEL_PLAYER_CURRENT_DATA,
    CHAR_DEL_PLAYER_COMPLETE_DATA,
