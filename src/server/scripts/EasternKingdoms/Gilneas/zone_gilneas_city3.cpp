...
public:
    ...
    struct npc_sister_almyra_38466AI : public ScriptedAI
    {
            ...
            while (uint32 eventId = m_events.ExecuteEvent())
            {
                ...
                case EVENT_FIGHT_WAVE:
                {
                    ...
                    if (m_nearestTarget)
                    {
                        ...
                        {
                            m_point += 1;
                            m_events.RescheduleEvent(EVENT_MOVE_WAVE, m_stepByStepDelay);
                        }
                        else
                        {
        ...
        Position GetWavePosition()
        {
            ...
            {
            case 1:
                return Wave1Pos[m_point];
            case 2:
                return Wave2Pos[m_point];
            case 3:
                return Wave3Pos[m_point];
            case 4:
                return Wave4Pos[m_point];
            case 5:
                return Wave5Pos[m_point];
            case 6:
                return Wave6Pos[m_point];
            case 7:
                return Wave7Pos[m_point];
            default:
                return Position(0, 0);
            }
        }
        ...
        void CheckForStartAction()
        {
            ...
            case 7:
            {
                if (m_point > 2 && !m_doneA) // let the fight vs sylvanas ending after 90sec
                {
                    m_doneA = true;
                    m_events.ScheduleEvent(EVENT_SYLVANAS_HAS_ENOUGH, 90000);
                }
                break;
            }
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = m_events.ExecuteEvent())
            {
                ...
                case EVENT_FIGHT_WAVE:
                {
                    ...
                    {
                        m_point += 1;
                        m_events.ScheduleEvent(EVENT_MOVE_WAVE, m_stepByStepDelay);
                    }
                    break;
                }
                }
...
public:
    ...
    struct npc_myriam_spellwaker_38465AI : public ScriptedAI
    {
        ...
        void Initialize()
        {
            ...
            m_almyraGUID = 0;
            m_isInitialised = false;
            m_stepByStepDelay = 1200;
            m_shootCoolDown = 6000;
            m_ai_counter = 0;
            m_events.ScheduleEvent(EVENT_INITIALISE, 1000);
            m_events.ScheduleEvent(EVENT_CHECK_FOR_TIMER, 1000);
        }
...
public:
    ...
    struct npc_lorna_crowley_38426AI : public ScriptedAI
    {
        ...
        Position Wave7Pos[4] =
        {
            ...
            {-1691.106f, 1616.214f, 20.48794f, 5.674835f}
        };
...
public:
    ...
    struct npc_lord_darius_crowley_38415AI : public ScriptedAI
    {
        ...
        Position Wave7Pos[4] =
        {
            ...
            {-1726.228f, 1647.169f, 20.4949f, 5.50598f},
            {-1708.856f, 1630.483f, 20.48794f, 5.549175f},
            {-1690.106f, 1615.214f, 20.48794f, 5.674835f}
        };
...
public:
    ...
    struct npc_lady_sylvanas_windrunner_38469AI : public ScriptedAI
    {
        ...
        void DoAction(int32 param) override
        {
            ...
            {
                Talk(0);
                m_events.ScheduleEvent(EVENT_SYLVANAS_ATTACK, 1000);
                break;
            }
            }
        }
            ...
            while (uint32 eventId = m_events.ExecuteEvent())
            {
                ...
                case EVENT_INITIALISE:
                {
                    if (!m_isInitialised)
                    {
                        ...
                        if (!m_liamGUID)
                            if (Creature* liam = me->FindNearestCreature(38474, 40.0f))
                                m_liamGUID = liam->GetGUID();

                        if (!m_kingGUID)
                            if (Creature* king = me->FindNearestCreature(38470, 40.0f))
                ...
                case EVENT_SYLVANAS_ATTACK:
                {
                    if (Creature* liam = sObjectAccessor->GetCreature(*me, m_liamGUID))
                        liam->GetMotionMaster()->MovePath(liam->GetGUID(), false);

                    me->CastSpell(me, 72113);
                    me->CastSpell(me, 72384);
                    m_events.ScheduleEvent(EVENT_SYLVANAS_ATTACK + 1, 1000);
                    break;
                }
                case EVENT_SYLVANAS_ATTACK + 1:
                {
                    me->CastSpell(me, 72114);
                    Talk(3);
                    m_events.ScheduleEvent(EVENT_SYLVANAS_ATTACK + 2, 1000);
                    break;
                }
                case EVENT_SYLVANAS_ATTACK + 2:
                {
