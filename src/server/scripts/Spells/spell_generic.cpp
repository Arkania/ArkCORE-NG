...
class spell_gen_gift_of_naaru : public SpellScriptLoader
{
    public:
        ...
        class spell_gen_gift_of_naaru_AuraScript : public AuraScript
        {
            ...
            {
                if (Unit* owner = GetUnitOwner())
                    amount += int32(owner->GetMaxHealth() * 0.20f / aurEff->GetTotalTicks());
            }
...
public:
        ...
        class spell_gen_forged_fury_SpellScript : public SpellScript
        {
            ...
            SpellCastResult CheckRequirement()
            {
                if (Unit* caster = GetExplTargetUnit()) 
                {
            ...
            void Register()
            {
                ...
                OnEffectHit += SpellEffectFn(spell_gen_forged_fury_SpellScript::BeforeEffect, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };
