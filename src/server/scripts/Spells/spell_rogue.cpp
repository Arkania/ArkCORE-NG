...
public:
    ...
    class spell_rog_smoke_bomb_AuraScript : public AuraScript
    {
        ...
        void Bomb(AuraEffect const* aurEff)
        {
            if (DynamicObject* dynObj = GetTarget()->GetDynObject(76577))
        ...
        void Register()
        {
            OnEffectPeriodic += AuraEffectPeriodicFn(spell_rog_smoke_bomb_AuraScript::Bomb, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY);
        }
    };
