...
public:
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        sLog->outString("Re-Loading Quests Starters...");
    ...
    {
        sLog->outString("Reloading creature summon groups...");
    ...
    {
        sLog->outString("Re-Loading GameObject Templates... (`gameobject_template`)");
    ...
    {
        sLog->outString("Re-Loading Item Templates... (`item_template`)");
    ...
    {
        sLog->outString("Reloading phase_definitions table...");
