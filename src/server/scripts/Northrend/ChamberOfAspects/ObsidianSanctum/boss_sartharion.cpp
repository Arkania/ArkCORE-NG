...
public:
    ...
    struct npc_twilight_eggsAI : public Scripted_NoMovementAI
    {
        npc_twilight_eggsAI(Creature* creature) : Scripted_NoMovementAI(creature)
        {
            instance = creature->GetInstanceScript();
        }
...
class npc_twilight_whelp_sarth : public CreatureScript
{
public:
    npc_twilight_whelp_sarth() : CreatureScript("npc_twilight_whelp_sarth") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_twilight_whelp_sarthAI(creature);
    }

    struct npc_twilight_whelp_sarthAI : public ScriptedAI
    {
        npc_twilight_whelp_sarthAI(Creature* creature) : ScriptedAI(creature)
        {
            Reset();
        }
