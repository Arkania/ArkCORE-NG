...
namespace rbac
{
    ...
    enum RBACPermissions
    {
        ...
        //end NpcBot
        RBAC_PERM_COMMAND_GOBJECT_SET_PHASEID = 805,
        RBAC_PERM_COMMAND_GOBJECT_SET_PHASEGROUP = 806,
        RBAC_PERM_COMMAND_NPC_SET_PHASEID = 807,
        RBAC_PERM_COMMAND_NPC_SET_PHASEGROUP = 808,
        RBAC_PERM_COMMAND_MODIFY_PHASEID = 809,
        RBAC_PERM_COMMAND_MODIFY_PHASEGROUP = 810,
