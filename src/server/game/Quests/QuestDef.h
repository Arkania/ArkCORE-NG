...
enum QuestFlags
{
    ...
    QUEST_FLAGS_AUTO_REWARDED           = 0x00000400,   // (WPP: Tracking) These quests are automatically rewarded on quest complete 
    ...
    QUEST_FLAGS_REMOVE_EXTRA_GET_ITEMS  = 0x02000000,   // (WPP: RemoveExtraGetItems)
    QUEST_FLAGS_HIDE_UNTIL_DISCOVERED   = 0x04000000,   // (WPP: HideUntilDiscovered)   
    QUEST_FLAGS_PORTRAIT_IN_QUEST_LOG   = 0x08000000,   // (WPP: PortraitInQuestLog) Found in quest 14069, Portrait in quest log
    QUEST_FLAGS_SHOW_ITEM_WHEN_COMPLETED = 0x10000000,  // (WPP: ShowItemWhenCompleted)   
    QUEST_FLAGS_LAUNCH_GOSSIP_ACCEPT    = 0x20000000,   // (WPP: LaunchGossipAccept)   
    QUEST_FLAGS_ITEMS_GLOW_WHEN_DONE    = 0x40000000,   // (WPP: ItemsGlowWhenDone) Found in quest 14126, last quest in kezan
    QUEST_FLAGS_FAIL_ON_LOGOUT          = 0x80000000,   // (WPP: FailOnLogout)
};
