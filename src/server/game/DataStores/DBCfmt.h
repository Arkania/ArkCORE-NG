...
char const DestructibleModelDatafmt[]="nxxixxxixxxixxxixxxxxxxx";
...
char const GtRegenMPPerSptfmt[]="nf";
...
char const SpellCategoriesEntryfmt[]="niiiiii";
...
char const SpellReagentsEntryfmt[]="niiiiiiiiiiiiiiii";
char const SpellScalingEntryfmt[]="niiiiffffffffffi";
char const SpellTotemsEntryfmt[]="niiii";
char const SpellTargetRestrictionsEntryfmt[]="nxiiii";
char const SpellPowerEntryfmt[]="niiiiixf";
char const SpellInterruptsEntryfmt[]="nixixi";
...
char const SpellCooldownsEntryfmt[]="niii";
char const SpellLevelsEntryfmt[]="niii";
