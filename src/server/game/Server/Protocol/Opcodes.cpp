...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                                                  \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_COMPLETION_NPC_RESPONSE,           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleQueryNpcCompletitionRespOpcode);
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_CHAT_SERVER_DISCONNECTED2,               STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(SMSG_NOTIFICATION2,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    //DEFINE_OPCODE_HANDLER(CMSG_LFG_PARTY_LOCK_INFO_REQUEST,               STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgPartyLockInfoRequestOpcode);
