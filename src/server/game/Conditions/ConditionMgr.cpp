...
bool ConditionMgr::isConditionTypeValid(Condition* cond)
{
    ...
    {
        sLog->outErrorDb("SourceType %u, SourceEntry %u, SourceGroup %u in `condition` table, has incorrect ConditionTarget set, ignoring.", cond->SourceType, cond->SourceEntry, cond->SourceGroup);
        return false;
    }
