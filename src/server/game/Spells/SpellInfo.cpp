...
bool SpellInfo::IsAuraExclusiveBySpecificWith(SpellInfo const* spellInfo) const
{
    ...
    switch (spellSpec1)
    {
        ...
        case SPELL_SPECIFIC_FOOND_DRINK_BUFF:
...
SpellSpecificType SpellInfo::GetSpellSpecific() const
{
    switch (SpellFamilyName)
    {
        case SPELLFAMILY_GENERIC:
        {
            ...
            // food / drink buff
            else if (AttributesEx2 & SPELL_ATTR2_FOOD_BUFF)
            {
                return SPELL_SPECIFIC_FOOND_DRINK_BUFF;
            }
            // scrolls effects
            else
            {
        ...
        case SPELLFAMILY_PALADIN:
        {
            // Collection of all the seal ids. No other paladin spell has any of those.
            if (Id == 20164 || Id == 20165 || Id == 31801 || Id == 20154)
