...
enum SpellSpecificType
{
    ...
    SPELL_SPECIFIC_FOOND_DRINK_BUFF              = 22,
    SPELL_SPECIFIC_PRESENCE                      = 23,
    SPELL_SPECIFIC_CHARM                         = 24,
    SPELL_SPECIFIC_SCROLL                        = 25,
    SPELL_SPECIFIC_MAGE_ARCANE_BRILLANCE         = 26,
    SPELL_SPECIFIC_WARRIOR_ENRAGE                = 27,
