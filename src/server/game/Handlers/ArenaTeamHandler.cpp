...
{
    TC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_CREATE");
    ...
    uint8 type = ArenaTeam::GetTypeBySlot(slot);
     ...
     TC_LOG_ERROR("bg.arena", "%u %u %u %u %u %u", iconcolor, bordercolor, type, icon, border, background);
